...
cd GEN_FOLDER_TEMP ; 
cp ../phantom_1_2_3/tools/gendir.scr ./
mkdir gen1
...
cat /afs/cern.ch/user/g/govoni/work/PHANTOM/phantom_at_cern/phantom_templates/run_1_2_3.TEMPLATE  | sed -e s%FOLDER%GEN_FOLDER_TEMP/gen1% > GEN_FOLDER_TEMP/gen1/run ;
